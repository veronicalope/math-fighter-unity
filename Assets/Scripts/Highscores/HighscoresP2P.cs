...
namespace MathFighter.Highscores
{
    /// <summary>
...
//        {
//            //#if XBOX
//            Debug.Log("P2P: stop() was called");

//            if (_state != EnumP2PState.Idle)
//            {
//                Debug.Log("P2P: stopping...");
...
//        }
        ...
        //    Debug.Log("P2P trying to find a session");
        ...
        //    Debug.Log("P2P trying to join a session");
        ...
        //    Debug.Log("P2P trying to create a session");
        ...
        //    Debug.Log("P2P processing client session");
        ...
        //            {
        //                //Debug.Log("recieved i is " + i + " vs count " + count + " and chunksize " + SCORE_INTEGRATION_CHUNKSIZE);
        ...
        //    Debug.Log("P2P processing host session");
        ...
        //            if (data != null)
        //            {
        //                Debug.Log("Host is sending score data");
