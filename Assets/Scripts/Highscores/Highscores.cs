    ...
    public class HighscoreData
    {
        ...
        public void Load()
        {
            ...
            try
            {
                ...
                string filename = "Assets/Resources/data/highscores/highscores.mfs";
                ...
                Debug.Log("Successfully loaded highscores");
            }
            catch (Exception e)
            {
                Debug.Log("Failed to load highscores! - message: " + e.Message);
        ...
        public void Save(bool forceSave)
        {
            ...
            try
            {
                ...
                Debug.Log("Successfully saved highscores");
            }
            catch (Exception e)
            {
                // failed to save the highscores - can display a message - for now we just let it fail silently
                Debug.Log("Failed to save highscores! - message: " + e.Message);
        ...
        public void UpdateGradeBadgeSprite(Sprite sprite, string gamerTag)
        {
            //int gradeBadge = 0;
