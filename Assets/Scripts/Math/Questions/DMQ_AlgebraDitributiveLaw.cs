...
namespace MathFighter.Math.Questions
{
    ...
    public class DMQ_AlgebraDitributiveLaw : DynamicMathQuestion
    {
        ...
        public override string[] GetContent()
        {
            ...
            // create the question
            content[0] = WrapMathString(var1.ToString() + " * ( " + var2.ToString() + " * <i>x</i> + " + var3.ToString() + (includeY ? " * <i>y</i> )" : ""));

            // create the correct answer
            content[1] = WrapMathString(answerCoefficient1.ToString() + " * <i>x</i> + " + answerCoefficient2.ToString() + (includeY ? " * <i>y</i>" : ""));
            ...
            for (int i = 2; i < 5; i++)
            {
                ...
                do
                {
                    ...
                    pertAnswer = WrapMathString(newAnswerCoefficient1.ToString() + " * <i>x</i> + " + newAnswerCoefficient2.ToString() + (includeY ? " * <i>y</i>" : ""));
