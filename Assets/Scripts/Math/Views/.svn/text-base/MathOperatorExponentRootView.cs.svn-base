...
namespace MathFreak.Math.Views
{
    public class MathOperatorExponentRootView : MathOperatorView
    {
        ...
        public MathOperatorExponentRootView(MathOperatorExponent op, float h, float spacing, SpriteFont font)
        {
        ...
        protected LogicalRenderTexture AssembleComponentTextures(float w, float h, float barWidth, LogicalRenderTexture opTexture, LogicalRenderTexture leftParamTexture, LogicalRenderTexture rightParamTexture)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.Draw(opTexture.Texture, new Vector2(rightParamTexture.Width * 0.5f, 0.0f), opTexture.Region, Color.White, 0.0f, Vector2.Zero, 1.0f, SpriteEffects.None, 0.5f);
