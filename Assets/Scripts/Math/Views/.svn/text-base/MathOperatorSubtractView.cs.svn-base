...
{
    public class MathOperatorSubtractView : MathOperatorView
    {
        public MathOperatorSubtractView(MathOperatorSubtract op, float h, float spacing, SpriteFont font)
        {
        ...
        protected LogicalRenderTexture AssembleComponentTextures(float spacing, LogicalRenderTexture opTexture, LogicalRenderTexture leftParamTexture, LogicalRenderTexture rightParamTexture)
        {
            ...
            // resovle and return the newly rendered texture
            lrt.ResolveTexture();
            return lrt;
        }
    }
