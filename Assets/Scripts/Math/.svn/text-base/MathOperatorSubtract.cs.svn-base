...
{
    /// <summary>
    /// Represents the subtraction operator in the internal math representation stuff.
    /// </summary>
    public class MathOperatorSubtract : MathOperator
    {
        ...
        public override MathElement Simplify_CombineIdenticalTermsInSubtraction()
        {
            ...
            // if the subtrees are identical then we can subtract them
            if (leftElement.EqualsSubtree(rightElement))
            {
                ...
                // based on the multiplier there are 3 cases to handle
                ...
                {
                    Assert.Fatal(false, "Unhandled case in Simplify_CombineIdenticalTermsInSubtraction()");
                }
            }
        ...
        {
            return new MathOperatorSubtractView(this, charHeight, spacing, font);
        }
    }
}
