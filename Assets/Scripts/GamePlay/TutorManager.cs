...
namespace MathFighter.GamePlay
{
    ...
    public class TutorManager
    {
        ...
        /*public Sprite GetVsSprite(int player, EnumTutor tutor)
        {
            return _tutors[player, (int)tutor].GetVsSprite(tutor);
        }

        public Sprite GetGamerPic(int player, EnumTutor tutor)
        {
        ...
        {
            return (TutorManager.EnumTutor)rnd.Next(0, TUTOR_COUNT);
        }
        ...
        public class Tutor
        {
            ...
            //            //Debug.Log("material: " + (_animData[(int)EnumAnim.Selected] as SimpleMaterial).TextureFilename);
